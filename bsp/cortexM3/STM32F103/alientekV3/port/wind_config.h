...
#define WIND_MUTEX_MAX_NUM 10 // Maximum number of mutexes that can be supported
...
#define CMD_FS_SUPPORT      1  // Whether the command "fs" is supported
#define CMD_MOUNT_SUPPORT   1  // Whether the command "mount" is supported
#define CMD_UMOUNT_SUPPORT  1  // Whether the command "umount" is supported
#define CMD_WRITE_SUPPORT   1  // Whether the command "write" is supported
#define CMD_CAT_SUPPORT     1  // Whether the command "cat" is supported
#define CMD_CD_SUPPORT      1  // Whether the command "cd" is supported
#define CMD_FORMAT_SUPPORT  1  // Whether the command "format" is supported
#define CMD_LS_SUPPORT      1  // Whether the command "ls" is supported
#define CMD_MKDIR_SUPPORT   1  // Whether the command "mkdir" is supported
#define CMD_PWD_SUPPORT     1  // Whether the command "pwd" is supported
#define CMD_RM_SUPPORT      1  // Whether the command "rm" is supported
#define CMD_TOUCH_SUPPORT   1  // Whether the command "touch" is supported
