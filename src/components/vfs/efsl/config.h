 ...
 * Here you can set the clock speed of your AVR. This settings will is
 * currently only used by the debugging functions for setting UBRR according
 ...
 * When debugging with the AVR-debugging functions, you need to specify the
