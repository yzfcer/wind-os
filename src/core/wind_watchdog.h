...
#define F_WATCHDOG_WARN (0x01 << 0) //Mark whether alarm occurs after watchdog timeout
...
#define F_WATCHDOG_RESET (0x01 << 1) //Mark whether to restart after watchdog timeout
